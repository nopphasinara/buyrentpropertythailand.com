...
$prop_id = str_ireplace('BRPT-BRPT-', 'BRPT-', $prop_id);
    ...
    <div class="alert alert-info">
        <ul class="list-three-col">
            ...
            if( !empty( $prop_id ) && $hide_detail_prop_fields['prop_id'] != 1 ) {
                echo '<li><strong>'.esc_html__( 'Property ID:', 'houzez').'</strong> '.str_ireplace('BRPT-BRPT-', 'BRPT-', houzez_propperty_id_prefix($prop_id)).'</li>';
            }
