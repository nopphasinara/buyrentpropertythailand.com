 ...
 * Time: 4:26 PM
 */
global $prop_video_img, $prop_video_url, $default_video_cover;

// Default video cover from media ID.
$default_video_cover = 3216;
...
if( !empty( $prop_video_url ) ) {
    ...
    if ( empty( $prop_video_img ) ) :
        ...
        if ( empty($prop_video_img) ) $prop_video_img = $default_video_cover;

    endif;

    $prop_video_img_url = wp_get_attachment_url($prop_video_img);
    if ( empty($prop_video_img_url) ) $prop_video_img = $default_video_cover;
?>
