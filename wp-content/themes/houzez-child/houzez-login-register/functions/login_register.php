<?php
/**
 * Created by Golcfish Creative Thailand.
 * User: gcreativeth
 * Date: 2018-10-21
 * Time: 1:29 PM
 */
...
function send_html_email($to_email, $subject = 'no subject', $message = '', $headers = [], $args = []) {
  $args = [
                 ...
                 <table id="header" width="100%" <?php table_reset_attrs(); ?> bgcolor="<?php set_color('light'); ?>" style="<?php table_reset_style_border(); ?>">
                   <tr>
                     <td valign="top" style="<?php set_padding('24px', '24px', '24px', '24px'); ?>">
                       ...
                       <a href="<?php echo $args['website_url']; ?>"><?php insert_image($args['email_head_logo'], $args['website_name'], '200'); ?></a>
                   ...
                   <tr>
                     <td valign="top" style="<?php set_padding('24px', '24px', '24px', '24px'); ?>">
                       ...
                       <table width="100%" <?php table_reset_attrs(); ?> style="<?php table_reset_style_border(); ?>">
                         <tr>
                           <td valign="top">
                             <?php echo $args['email_footer_content']; ?>
                           </td>
                         </tr>
                         <tr>
                           <td valign="top">
                             <?php echo $args['socials']; ?>
                           </td>
                         </tr>
                       </table>
