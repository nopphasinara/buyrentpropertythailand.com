...
<div class="tab-content">
    ...
    <div class="tab-pane fade">
        ...
        <form>
            <div class="form-group field-group">
                <div class="input-user input-icon">
                    <input id="first_name" name="first_name" type="text" placeholder="<?php esc_html_e('First name','houzez'); ?>" />
                </div>
                <div class="input-user input-icon">
                    <input id="last_name" name="last_name" type="text" placeholder="<?php esc_html_e('Last name','houzez'); ?>" />
                </div>
                <div class="input-user input-icon">
            ...
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        ...
                        <?php echo sprintf( wp_kses(__( 'I agree with your <a href="%s" target="_blank">Terms & Conditions</a>', 'houzez' ), $allowed_html_array), get_permalink($terms_conditions) ); ?>
                    </label>
                </div>
            </div>
