        ...
        <div class="add-tab-row push-padding-bottom">
            <div class="row">
                ...
                <?php if( $hide_add_prop_fields['land_area'] != 1 ) { ?>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="prop_land_area"><?php echo esc_html__('Land Size ( Only digits )', 'houzez').houzez_required_field( $required_fields['land_area'] ); ?></label>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="prop_land_area_prefix"><?php esc_html_e('Rai, Tw, Sqm', 'houzez'); ?></label>
