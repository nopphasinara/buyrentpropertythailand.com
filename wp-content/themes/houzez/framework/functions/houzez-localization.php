	...
	function houzez_get_localization() {
		...
		$localization = array(
			...
			*------------------------------------------------------*/
			...
			'prop_sale_rent_price_placeholder'	=> esc_html__( 'Enter Sale Price', 'houzez' ),
			...
			'prop_second_price_placeholder'	=> esc_html__( 'Enter your property rent price', 'houzez' ),
			// 'prop_second_price_placeholder'	=> esc_html__( 'Enter your property second price', 'houzez' ),
			'prop_price_label'	=> esc_html__( 'Rent Price Label (ex: Per Month)', 'houzez' ),
			// 'prop_price_label'	=> esc_html__( 'After Price Label (ex: monthly)', 'houzez' ),
			'prop_price_prefix'	=> esc_html__( 'Price Label (ex: Start from)', 'houzez' ),
