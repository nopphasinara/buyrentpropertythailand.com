	...
	function houzez_get_localization() {
		...
		$localization = array(
			...
			*------------------------------------------------------*/
			...
			'prop_sale_rent_price'	=> esc_html__( 'Sale Price', 'houzez' ),
			// 'prop_sale_rent_price'	=> esc_html__( 'Sale or Rent Price', 'houzez' ),
			'prop_sale_rent_price_placeholder'	=> esc_html__( 'Enter price', 'houzez' ),
			// 'prop_sale_rent_price_placeholder'	=> esc_html__( 'Enter Sale or Rent Price', 'houzez' ),
			'prop_second_price'	=> esc_html__( 'Rent Price (Optional)', 'houzez' ),
			// 'prop_second_price'	=> esc_html__( 'Second Price (Optional)', 'houzez' ),
			'prop_second_price_placeholder'	=> esc_html__( 'Enter price', 'houzez' ),
			// 'prop_second_price_placeholder'	=> esc_html__( 'Enter your property second price', 'houzez' ),
			'prop_price_label'	=> esc_html__( 'Rent Price Label (ex: Per Month/Per Year)', 'houzez' ),
			// 'prop_price_label'	=> esc_html__( 'After Price Label (ex: monthly)', 'houzez' ),
			'prop_price_prefix'	=> esc_html__( 'Sale Price Label (ex: Sale Price, Prices Start From)', 'houzez' ),
			// 'prop_price_prefix'	=> esc_html__( 'Price Prefix (ex: Start from)', 'houzez' ),
			'prop_price_prefix_placeholder'	=> esc_html__( 'Enter before sale price label', 'houzez' ),
			'prop_price_label_placeholder'	=> esc_html__( 'Enter after rent price label', 'houzez' ),
