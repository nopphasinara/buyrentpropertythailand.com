...
(function ($) {
    ...
    $.fn.ShareLink = function(options){
        ...
        var templates = {
            ...
            odnoklassniki: 'https://odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st._surl={url}&st.comments={text}',
            ...
            visitezmonsite: 'https://www.visitezmonsite.com/publier?url={url}&title={title}&body={text}',
            ...
            yardbarker: 'https://www.yardbarker.com/author/new/?pUrl={url}&pHead={title}',
            ...
            zakladoknet: 'https://zakladok.net/link/?u={url}&t={title}',
            ...
            for(var i = 0; i < classlist.length; i++){
                ...
                if(cls.substr(0, class_prefix_length) == options.class_prefix && templates[cls.substr(class_prefix_length)]){
                    ...
                    $(elem).attr('href', final_link).click(function(){
                        if($(this).attr('href').indexOf('https://') === -1 && $(this).attr('href').indexOf('https://') === -1){
