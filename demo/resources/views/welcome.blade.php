                                                ...
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/01_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/02_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/03_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/04_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/05_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/06_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/07_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/08_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/09_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/10_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/11_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                                            ...
                                            <div class="property-item item-grid">
                                                <div class="figure-block">
                                                    <figure class="item-thumb">
                                                        ...
                                                        <a href="#" class="hover-effect">
                                                            <img src="{{ asset('vendor/houzez') }}/images/listings/12_385x258.jpg" alt="thumb">
                                                        </a>
                                                        <ul class="actions">
                                                            <li class="share-btn">
                                                                <div class="share_tooltip fade">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="location-block">
                                <figure>
                                    <a href="#">
                                        <img src="{{ asset('vendor/houzez') }}/images/taxonomy-grid/01_370x370.jpg" width="370" height="370" alt="Apartment">
                                    </a>
                        ...
                        <div class="col-sm-8">
                            <div class="location-block">
                                <figure>
                                    <a href="#">
                                        <img src="{{ asset('vendor/houzez') }}/images/taxonomy-grid/01_770x370.jpg" width="770" height="370" alt="Loft">
                                    </a>
                        ...
                        <div class="col-sm-8">
                            <div class="location-block">
                                <figure>
                                    <a href="#">
                                        <img src="{{ asset('vendor/houzez') }}/images/taxonomy-grid/02_770x370.jpg" width="770" height="370" alt="Single Family Home">
                                    </a>
                                    <div class="location-fig-caption">
                        ...
                        <div class="col-sm-4">
                            <div class="location-block">
                                <figure>
                                    <a href="#">
                                        <img src="{{ asset('vendor/houzez') }}/images/taxonomy-grid/02_370x370.jpg" width="370" height="370" alt="Villa">
                                    </a>
                                    <div class="location-fig-caption">
                                        ...
                                        <div class="property-item item-grid">
                                            <div class="figure-block">
                                                <figure class="item-thumb">
                                                    ...
                                                    <a href="#" class="hover-effect">
                                                        <img src="{{ asset('vendor/houzez') }}/images/listings/13_434x290.jpg" alt="thumb">
                                                    </a>
                                                    <ul class="actions">
                                                        <li class="share-btn">
                                                            <div class="share_tooltip fade">
                                        ...
                                        <div class="property-item item-grid">
                                            <div class="figure-block">
                                                <figure class="item-thumb">
                                                    ...
                                                    <a href="#" class="hover-effect">
                                                        <img src="{{ asset('vendor/houzez') }}/images/listings/14_434x290.jpg" alt="thumb">
                                                    </a>
                                                    <ul class="actions">
                                                        <li class="share-btn">
                                                            <div class="share_tooltip fade">
